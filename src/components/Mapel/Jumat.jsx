	...
	return (
		<>
			...
			<div
				...
				<div className="w-[50%] text-base  font-medium">PAI</div>
				<div className="flex justify-center items-center text-sm">09.35-10.10</div>
			</div>
			<div
				...
				<div className="flex justify-center items-center text-sm">10.10-10.45</div>
			</div>
			<div
				className=" flex justify-between py-[0.50rem] w-72 px-3 opacity-60"
				data-aos="fade-up"
				...
				<div className="flex justify-center items-center text-sm">10.45-11.20</div>
			</div>
